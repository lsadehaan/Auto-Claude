...
export const CHANNEL_TO_HTTP: Record<string, EndpointMapping> = {
  ...
  'task:delete': { method: 'DELETE', path: '/tasks/{0}', pathArgs: [0], queryParams: ['projectPath'] },
  ...
  'task:checkRunning': { method: 'GET', path: '/tasks/{0}/status', pathArgs: [0], queryParams: ['taskId'] },
